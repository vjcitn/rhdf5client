...
This R package includes proof-of-concept code illustrating access to files stored on remote HDF5 server.
...
Data are accessed by subscripting. The subscripts are colon-delimited character 
